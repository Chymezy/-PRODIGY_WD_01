    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="mt-4 text-sm text-white">{t('hero.offer')}</p>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {['boostRevenue', 'saveTime', 'scaleFaster'].map((item) => (
              <div key={item} className="text-center">
                <div className="text-5xl mb-4 text-purple-700 dark:text-purple-400">
                  {t(`about.${item}.icon`)}
                </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {['predictiveAnalytics', 'nlp', 'computerVision'].map((service) => (
              <div 
                key={service}
                className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300"
              >
                <div className="text-4xl mb-4 text-purple-700 dark:text-purple-400">
